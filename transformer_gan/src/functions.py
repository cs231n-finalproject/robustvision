...
from transformer_gan.src.metrics.fid_score import calculate_fid_given_paths
from transformer_gan.src.metrics.torch_fid_score import get_fid
from transformer_gan.src.metrics.inception_score import get_inception_score
...
def train(args, gen_net: nn.Module, dis_net: nn.Module, gen_optimizer, dis_optimizer, gen_avg_param, train_loader,
          epoch, writer_dict, fixed_z, schedulers=None, z=None):
