...
from transformer_gan.models.ViT_helper import DropPath, to_2tuple, trunc_normal_
...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
        ...
        self.mlp = Mlp(dim, mlp_hidden_dim, activ=act_layer, drop=drop)
...
class Mlp(nn.Module):
    def __init__(self, in_c, hidden_c=None, out_c=None, activ=GELU, drop=0.):
        super().__init__()
        out_c = out_c or in_c
