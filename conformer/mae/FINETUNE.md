...
python3 main_finetune.py --eval --resume ./checkpoints/mae_finetuned_vit_huge.pth --model vit_huge_patch14 --batch_size 16 --data_path ~/Dataset/ImageNet_ILSVRC2012
