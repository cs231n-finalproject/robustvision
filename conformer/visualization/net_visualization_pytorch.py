...
def compute_saliency_maps(X, y, model, head=-1):
    """
...
def make_fooling_image(X, target_y, model, head=-1):
    """
...
def class_visualization_update_step(img, model, target_y, l2_reg, learning_rate, head=-1):
    ########################################################################
